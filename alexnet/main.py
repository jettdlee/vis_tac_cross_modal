...
last update Jet-Tsyn Lee v0.4 12/09/2018
...
train_file = './txt/train_v_real.txt'
val_file = './txt/val_v.txt'
test_file = "./txt/test_v.txt"

#train_file = './txt/train_v_gen.txt'
#val_file = './txt/val_v.txt'
#test_file = "./txt/test_v.txt"

#train_file = '/txt/train_t_real.txt'
#val_file = '/txt/val_t.txt'
#test_file = "./txt/test_t.txt"

#train_file = './txt/train_t_gen.txt'
#val_file = './txt/val_t.txt'
#test_file = "./txt/test_t.txt"

#train_file = './txt/train_v_real_min.txt'
#val_file = './txt/val_v.txt'
#test_file = "./txt/test_v.txt"

#train_file = './txt/train_v_gen_min.txt'
#val_file = './txt/val_v.txt'
#test_file = "./txt/test_v.txt"

#train_file = '/txt/train_t_real_min.txt'
#val_file = '/txt/val_t.txt'
#test_file = "./txt/test_t.txt"

#train_file = './txt/train_t_gen_min.txt'
#val_file = './txt/val_t.txt'
#test_file = "./txt/test_t.txt"
